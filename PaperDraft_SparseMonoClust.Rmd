...
```{r MotivatingExample, echo=FALSE, fig.cap="Motivating Example showing improved monothetic clustering results", out.width = '90%'}
knitr::include_graphics("SparseMotivatingExample.png")
```
...
```{r ExTooSparse, echo=FALSE, fig.cap="Monothetic bipartitions, gap statistic values, and feature weights for too-sparse scenario.", out.width = '90%'}
knitr::include_graphics("TooSparseExample.png")
```
...
```{r GapPlot1, echo=FALSE, fig.cap="Gap Statistics across s, k visualized in two methosds.", out.width = '90%'}
knitr::include_graphics("Gap2Ways.png")
```
...
```{r NumClust, echo=FALSE, fig.cap="Optimal Number of Clusters Chosen by Each of the Rules across 10 simulations.", out.width = '90%'}
knitr::include_graphics("OptimalKPlot.png")
```
...
```{r FeatureWeights, echo=FALSE, fig.cap="Weights of features from gap-tuned sparse monothetic clustering.", out.width = '90%'}
knitr::include_graphics("Feature_Weights_425sims.png")
```
...
```{r SimulationRealized, echo=FALSE, fig.cap="Realization of the simulated datasets.", out.width = '90%'}
knitr::include_graphics("SimulatedRealization.png")
```
